...
CREATE DATABASE project WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_US.UTF-8' LC_CTYPE = 'en_US.UTF-8';
...
CREATE TABLE teamchampionship (
    ...
    CONSTRAINT place_of_team_check CHECK ((place_of_team > 0))
);
...
INSERT INTO player VALUES (26, 'M?ller', 'MICHU', '1996-03-30', 3, '2016-06-07', 6);
